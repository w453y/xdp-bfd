...
engine-free injector (milestones/08-echo/echo_inject.py, self-addressed
...
(milestones/08-echo/echo-reflect-host.pcap).
...
Validated on the wire in investigations/v6-echo: one config, 15s per arm at a
