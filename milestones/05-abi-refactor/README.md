...
Verified (milestones/05-abi-refactor/spoof_options.py): 200 optioned packets
...
Verified (milestones/05-abi-refactor/bad_frame.py): a harness connects to the
...
### Full regression (milestones/05-abi-refactor/, regress-abi.pcap)
...
### Graceful restart (dp-hold window, milestones/05-abi-refactor/hold.txt)
...
### Echo trim (milestones/05-abi-refactor/trim.pcap, spoof_long.py)
...
### IP-options bypass (milestones/05-abi-refactor/spoof_options.py)
...
### Bad frame length (milestones/05-abi-refactor/bad_frame.py)
